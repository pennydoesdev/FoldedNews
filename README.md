...
> Build status: **Stage 2 — Core newsroom content model**. The platform is built
> in 20 staged increments (see the project plan). Each stage must build, test,
> and pass manual QA before the next begins.
